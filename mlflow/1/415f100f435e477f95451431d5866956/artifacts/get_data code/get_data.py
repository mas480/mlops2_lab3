...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/am/project/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")
 
key = "AIzaSyAfjkj218xjIA5dF6hi0APsVp09KKE7zS8"
api = Api(api_key=key)
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/am/project/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()

with open('/home/am/project/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))